...
public class SquareMenu extends View {
    ...
    private SquareMenuClickListener onMenuClickListener = null;
    ...
    private void setupAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            bitmapM1 = BitmapFactory.decodeResource(getResources(), R.styleable.SquareMenu_iconM1);
            bitmapM2 = BitmapFactory.decodeResource(getResources(), R.styleable.SquareMenu_iconM2);
            bitmapM3 = BitmapFactory.decodeResource(getResources(), R.styleable.SquareMenu_iconM3);
        } finally {
    ...
    private void drawSquares4TopLeftMenu(Canvas canvas){
        ...
        // Draw BG Rect
        //canvas.drawRect(getMeasuredWidth() / 2- FAB_MARGIN, getMeasuredHeight() / 2 - FAB_MARGIN,
        //        getMeasuredWidth() - FAB_MARGIN, getMeasuredHeight() - FAB_MARGIN, paintFabBG);
        ...
        canvas.drawRect(0, 0, getMeasuredWidth(), getMeasuredHeight(), paintFAB);
        canvas.restore();
     ...
     */
    public void setOnMenuClickListener(SquareMenuClickListener onMenuClickListener) {
